...
declare module '$env/static/private' {
	...
	export const _AUVIK_OPS_PROMPT_NO_OVERRIDE: string;
	...
	export const NPL: string;
	export const npm_lifecycle_event: string;
	export const npm_config__jsr_registry: string;
	export const EDITOR: string;
	export const PRIVATE_AUVIK_CREDENTIALS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		_AUVIK_OPS_PROMPT_NO_OVERRIDE: string;
		NPM_TOKEN: string;
		PATH: string;
		...
		EDITOR: string;
		PRIVATE_AUVIK_CREDENTIALS: string;
